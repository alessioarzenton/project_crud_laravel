                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="my-5">
                            ...
                            <form id="contactForm" action="{{route('cars.store')}}" method="POST">
                                @csrf
                                <div class="form-floating">
                                    <input name="brand" value="{{old('brand')}}" class="form-control @error('brand')
                                    is-invalid
                                    @enderror" id="brand" type="text" placeholder="Enter a brand..." />
                                    <label for="brand">Brand</label>
                                </div>
                                <div class="form-floating">
                                    <input name="model" value="{{old('model')}}" class="form-control @error('model')
                                    is-invalid
                                    @enderror" id="model" type="text" placeholder="Enter a model..." />
                                    <label for="model">Model</label>
                                </div>
                                <div class="form-floating">
                                    <input name="year" value="{{old('year')}}" class="form-control @error('year')
                                    is-invalid
                                    @enderror" id="year" type="number" placeholder="Enter a year..." />
                                    <label for="year">Year</label>
                                </div>
                                <div class="form-floating">
                                    <input name="price" value="{{old('price')}}" class="form-control @error('price')
                                    is-invalid
                                    @enderror" id="price" type="number" placeholder="Enter a price..." />
                                    <label for="price">Price</label>
                                </div>
                                <div class="form-floating">
                                    <input name="img" value="{{old('img')}}" class="form-control @error('img')
                                    is-invalid
